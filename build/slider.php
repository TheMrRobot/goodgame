    ...
    <div id="hero-revslider" class="rev_slider" style="display:none;" data-version="5.4.7.2">
      <ul>
        ...
        <li data-transition="fade" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="default" data-easeout="default" data-masterspeed="300" data-rotate="0" data-saveperformance="off" data-title="Slide">
          ...
          <!-- MAIN IMAGE -->
          <img src="http://labo.fnac.com/wp-content/uploads/2018/09/WoW-Classic.jpg" data-bgcolor='#1d1429' alt="" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="off" class="rev-slidebg" data-no-retina>
          <!-- LAYERS -->
          ...
          <div class="tp-caption tp-resizeme alc-hero-slider__h alc-hero-slider__h--h1 rs-parallaxlevel-10"
            ...
            style="z-index: 6;">
              <div class="rs-looped rs-wave" data-speed="2" data-angle="0" data-radius="2px" data-origin="50% 50%">World Of Warcraft</div>
          </div>
          ...
          <div class="tp-caption tp-resizeme alc-hero-slider__h alc-hero-slider__h--h1 alc-hero-slider__h--color-primary rs-parallaxlevel-10"
            ...
            style="z-index: 7;">
              <div class="rs-looped rs-wave" data-speed="2" data-angle="0" data-radius="2px" data-origin="50% 50%">Classic</div>
          </div>
          ...
          <div class="tp-caption tp-resizeme rs-parallaxlevel-10"
            ...
            style="z-index: 10;"><a href="_esports_team-player.html" class="btn btn-primary btn-icon-right">Lire le dossier <i class="fa fa-angle-right"></i></a>
          </div>
        ...
        <li data-transition="fade" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="default" data-easeout="default" data-masterspeed="300" data-rotate="0" data-saveperformance="off" data-title="Slide">
          ...
          <div class="tp-caption tp-resizeme alc-hero-slider__h alc-hero-slider__h--h1 rs-parallaxlevel-10"
            ...
            style="z-index: 6;">
              <div class="rs-looped rs-wave" data-speed="2" data-angle="0" data-radius="2px" data-origin="50% 50%">World Of Wacraft</div>
          </div>
          ...
          <div class="tp-caption tp-resizeme rs-parallaxlevel-10"
            ...
            style="z-index: 10;"><a href="_esports_team-overview.html" class="btn btn-primary-inverse btn-icon-right">Lire le dossier <i class="fa fa-angle-right"></i></a>
          </div>
        ...
        <li data-transition="fade" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="default" data-easeout="default" data-masterspeed="300" data-rotate="0" data-saveperformance="off" data-title="Slide">
          ...
          <div class="tp-caption tp-resizeme rs-parallaxlevel-10"
            ...
            style="z-index: 10;">
            <a href="_esports_blog-post-3.html" class="btn btn-primary-inverse btn-icon-right">Read full story <i class="fa fa-angle-right"></i></a>
          </div>
